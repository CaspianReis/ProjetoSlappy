...
<?php
    ...
    if(isset($comentario_usuario)) {
        ...
        $codigo_homebrew = $_SESSION['codigo_homebrew'];
         if($comentario_usuario == null){
            echo "Voce precisa digitar algo antes de enviar";
         }else{

            $con_comentario = "insert into tb_comentario_homebrew value(null, '".$codigo."', '".$codigo_homebrew."', '".$comentario_usuario."', '".$data."', '".$hora."')";
    ...
    <?php
             ...
             $sel_like = "select * from tb_curtir where id_post = '".$_SESSION['ident_post']."'";
